...
urlpatterns = [
    ...
    # ── GRADING SCALE + WEIGHTAGE CONFIG ────────────────────────────────────
    path('grading-scales/',
         views.grading_scale_list,
         name='grading_scale_list'),

    path('grading-scales/create/',
         views.create_grading_scale,
         name='create_grading_scale'),

    path('grading-scales/<int:scale_id>/edit/',
         views.create_grading_scale,
         name='edit_grading_scale'),

    path('grading-scales/<int:scale_id>/delete/',
         views.delete_grading_scale,
         name='delete_grading_scale'),

    path('classes/<int:class_id>/term-weightage/',
         views.term_weightage_config,
         name='term_weightage_config'),

    path('plans/<int:plan_id>/subject/<int:subject_id>/components/',
         views.assessment_component_config,
         name='assessment_component_config'),
